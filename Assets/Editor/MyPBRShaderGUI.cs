...
{
    internal class MyPBRShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            ////////////// chapter6_5 //////////////
            public static GUIContent iorText = EditorGUIUtility.TrTextContent("IOR", "IOR value");
            public static GUIContent materialTypeText = EditorGUIUtility.TrTextContent("Material Type", "Material Type value");
        ...
        MaterialProperty materialType = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            ////////////// chapter6_5 //////////////
            ior = FindProperty("_IOR", props);
            materialType = FindProperty("_MaterialType", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(materialType, Styles.materialTypeText, 2);
                DoNormalArea();
